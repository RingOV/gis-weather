...
def get_weather(service, weather, n, city_id, show_block_tomorrow, show_block_today, timer_bool, weather_lang, icons_name):
    if service == 0:
    ...
    if service == 2:
        return accuweather.get_weather(weather, n, city_id, show_block_tomorrow, show_block_today, timer_bool, weather_lang, icons_name)